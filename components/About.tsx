  ...
  return (
    <Section id="about" title="About Me">
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div
          className="md:w-1/3 flex justify-center opacity-0 animate-fade-in-up"
        ...
        <div
          className="md:w-2/3 text-center md:text-left opacity-0 animate-fade-in-up"
        ...
        >
          <p className="text-lg mb-4 text-light-onBackground/80 dark:text-dark-onBackground/80">
            ...
            in .NET technology. With a strong background in both front-end and
            back-end development, I am well-versed in creating dynamic and
            user-friendly web applications.
          </p>
          <p className="text-lg mb-6 text-light-onBackground/80 dark:text-dark-onBackground/80">
            Proactive in learning new technologies and continuously improving
            skills. A team player with a positive attitude and a passion for
            creating innovative software solutions.
          </p>
          <div className="flex justify-center md:justify-start space-x-6">
            <a
              href="https://www.linkedin.com/in/deepika-shamala-40a822240/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-light-onBackground dark:text-dark-onBackground hover:text-light-primary dark:hover:text-dark-primary transition-colors duration-300"
            >

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-4 opacity-0 animate-fade-in-up"
          style={{ animationDelay: "200ms" }}
        >
          <span className="block">Hi, I'm Deepika Shamala</span>
          <span className="block text-light-primary dark:text-dark-primary">
            A Full Stack Engineer
          </span>
        </h1>
        <p
          className="max-w-2xl mx-auto text-lg md:text-xl text-light-onBackground/80 dark:text-dark-onBackground/80 mb-8 opacity-0 animate-fade-in-up"
          style={{ animationDelay: "400ms" }}
        >
          Fullstack developer with 3 years of expertise in .NET Core and have
          strong experience with microservice architectures. I build web
          applications using Angular and work with relational databases like SQL
          Server, and PostgreSQL, with solid knowledge of Entity Framework. I am
          also familiar with few AWS services.
        </p>
        <div
